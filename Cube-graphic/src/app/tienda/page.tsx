            ...
            <div className="group relative overflow-hidden rounded-2xl shadow-2xl bg-white transition-all duration-500 mx-2">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white z-10">
                ...
                <Link
                  ...
                  className="block w-full bg-gradient-to-r from-pink-500 to-pink-600 text-white px-6 py-3 rounded-full hover:from-pink-600 hover:to-pink-700 transition-all font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 duration-200 text-center"
                >
                  Ver Detalles ›
                </Link>
              </div>
